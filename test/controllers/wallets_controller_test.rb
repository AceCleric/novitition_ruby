...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { add_credit: @wallet.add_credit, credit: @wallet.credit, remove_credit: @wallet.remove_credit, user_id: @wallet.user_id } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { add_credit: @wallet.add_credit, credit: @wallet.credit, remove_credit: @wallet.remove_credit, user_id: @wallet.user_id } }
