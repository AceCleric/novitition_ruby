...
class PredictionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post predictions_url, params: { prediction: { points: @prediction.points, team_id: @prediction.team_id, user_id: @prediction.user_id, will_win: @prediction.will_win } }
    end
  ...
  test "should update prediction" do
    patch prediction_url(@prediction), params: { prediction: { points: @prediction.points, team_id: @prediction.team_id, user_id: @prediction.user_id, will_win: @prediction.will_win } }
